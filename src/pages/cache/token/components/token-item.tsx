import { Button, Card, theme } from 'ant-design-vue'
import { CopyAble } from '@/components/tools'
        ...
        <div class="flex">
          ...
          <ul class="flex flex-1 flex-col pl-7 text-info-8">
            <li class="flex items-center">
              <span class="text-sm font-600">Access Token: </span>
              <div class="group flex items-center">
                <CopyAble text={props.item.accessToken}>
                  <span class="font-semibold">{props.item.show ? props.item.accessToken : '**********'}</span>
                </CopyAble>
              </div>
            </li>
            <li class="text-info-4 py-1">Added on {formatDate(props.item.createdDate)}</li>
            <li class="flex items-center">
              <span class="text-sm font-600">Mode:</span>
              <span class="pl-2 text-gray-700 dark:text-white/70">
...
const Edit = (
  <svg
    class="ml-2 !cursor-pointer link hover:!opacity-70"
    width="16"
    height="16"
    viewBox="0 0 15 15"
    fill="none"
...
const Token = (
  <svg class="text-gray-500 size-8" xmlns="http://www.w3.org/2000/svg" width="2em" height="2em" viewBox="0 0 24 24">
    <path
      fill="currentColor"
